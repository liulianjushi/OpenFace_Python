...
namespace LandmarkDetector
{
	...
	//================================================================================================================
	bool DetectLandmarksInVideo(const cv::Mat &rgb_image, LandmarkDetector::CLNF& clnf_model, LandmarkDetector::FaceModelParameters& params, cv::Mat &grayscale_image);
	bool DetectLandmarksInVideo(const cv::Mat &rgb_image, const cv::Rect_<double> bounding_box, LandmarkDetector::CLNF& clnf_model, LandmarkDetector::FaceModelParameters& params, cv::Mat &grayscale_image);
	...
	// Can also optionally pass a grayscale image if it has already been computed to speed things up a bit
	//================================================================================================================
	bool DetectLandmarksInImage(const cv::Mat &rgb_image, LandmarkDetector::CLNF& clnf_model, LandmarkDetector::FaceModelParameters& params, cv::Mat &grayscale_image);
	// Providing a bounding box
	bool DetectLandmarksInImage(const cv::Mat &rgb_image, const cv::Rect_<double> bounding_box, LandmarkDetector::CLNF& clnf_model, LandmarkDetector::FaceModelParameters& params, cv::Mat &grayscale_image);
	...
	cv::Vec6f GetPose(const LandmarkDetector::CLNF& clnf_model, float fx, float fy, float cx, float cy);
	cv::Vec6f testcv2();
	...
	// The format returned is [Tx, Ty, Tz, Eul_x, Eul_y, Eul_z]
	cv::Vec6f GetPoseWRTCamera(const LandmarkDetector::CLNF& clnf_model, float fx, float fy, float cx, float cy);
}
