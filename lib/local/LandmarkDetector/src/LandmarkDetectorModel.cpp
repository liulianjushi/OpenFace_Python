...
bool CLNF::DetectLandmarks(const cv::Mat_<uchar> &image, LandmarkDetector::FaceModelParameters& params)
{
...
//=============================================================================
bool CLNF::Fit(const cv::Mat_<float>& im, const std::vector<int>& window_sizes, const LandmarkDetector::FaceModelParameters& parameters)
{
	...
	LandmarkDetector::FaceModelParameters tmp_parameters = parameters;
