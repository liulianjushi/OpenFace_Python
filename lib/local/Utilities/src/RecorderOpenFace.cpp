...
RecorderOpenFace::RecorderOpenFace(const std::string in_filename, const Utilities::RecorderOpenFaceParameters& parameters, std::vector<std::string>& arguments):video_writer(), params(parameters)
{
...
RecorderOpenFace::RecorderOpenFace(const std::string in_filename, const Utilities::RecorderOpenFaceParameters& parameters, std::string output_directory):video_writer(), params(parameters)
{
	// From the filename, strip out the name without directory and extension
	if (boost::filesystem::is_directory(in_filename))
	{
