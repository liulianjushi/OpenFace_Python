...
namespace Utilities
{
	...
	*/
	...
	public:
		...
		RecorderOpenFace(const std::string in_filename, const Utilities::RecorderOpenFaceParameters& parameters, std::vector<std::string>& arguments);
		RecorderOpenFace(const std::string in_filename, const Utilities::RecorderOpenFaceParameters& parameters, std::string output_directory);
